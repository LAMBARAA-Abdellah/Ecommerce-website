...
function custom_plugin_setting_page() {
    ...
    add_menu_page('Custom Plugin', 'lambaraa Footer Setting', 'manage_options', 'custom-plugin-setting-url', 'custom_page_html_form' , plugins_url('custom-plugin/img/icon.png'));
    ...
    function custom_page_html_form() { ?>
        <div class="wrap">
            <h2>Lambaraa Footer Plugin Setting</h2>
